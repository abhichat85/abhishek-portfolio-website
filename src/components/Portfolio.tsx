...
import StarsCanvas from "@/components/Stars"  // Import the StarsCanvas component
...
export default function Portfolio() {
  ...
  const ELbuttonStyle = "bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600 rounded-md px-6 py-2 shadow-md transition-all duration-300 rounded-full"
  ...
  return (
    <div className={`min-h-screen font-['Bricolage_Grotesque',sans-serif] ${bgStyle} pt-24 p-8 transition-colors duration-500 relative overflow-hidden`}>
      ...
      {/* Wrap the rest of the content in a relative div with a higher z-index */}
